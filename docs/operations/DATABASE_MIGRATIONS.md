...
| `20260903090100_rls_evidence_tables` | Generated policies for the Stage 03 tables (manifest `RLS_MANIFESTS[2]`); `PromptVersion` is `system` kind — the tenant role cannot read prompts | Reversible |
