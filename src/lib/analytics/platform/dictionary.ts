...
export const PLATFORM_METRIC_DICTIONARY: readonly PlatformMetricDefinition[] = [
  ...
  { key: 'subscribers', product: 'financial', label: 'Subscribers', kind: 'snapshot', definition: 'Active, trialing, past-due and canceled subscriptions at the end of the day.', source: 'DailyRevenueRollup.activeSubscriptions' },
  ...
  { key: 'outcomes', product: 'cases', label: 'Employment outcomes', kind: 'count', definition: 'Outcomes recorded that day; cut by kind (employed, self_employed, training, other). Distinct clients in people; suppressed under five.', source: 'OrganizationDailyMart.cases.outcomes' },
