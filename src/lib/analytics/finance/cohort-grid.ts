 ...
 *
 * Stage 21 (ADR-0036): moved here from the console page module unchanged. The
 * revenue page now reads `SubscriptionCohortMart`, which the finance rollup
 * writes from this same builder; the page module re-exports these.
 */

import { addUtcMonths, labelFor, monthKey, startOfUtcMonth } from '../time';
